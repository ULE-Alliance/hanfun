...
{
   uint16_t count;
   const HF::Profiles::Interface * itf;
   ...
   LONGS_EQUAL(HF::Interface::ON_OFF, itf->uid);
   ...
   LONGS_EQUAL(HF::Interface::LEVEL_CONTROL, itf->uid);
   LONGS_EQUAL(HF::Interface::SERVER_ROLE, itf->role);
   ...
   LONGS_EQUAL(HF::Interface::SIMPLE_POWER_METER, itf->uid);
   LONGS_EQUAL(HF::Interface::SERVER_ROLE, itf->role);
   ...
   LONGS_EQUAL(HF::Interface::ALERT, itf->uid);
   LONGS_EQUAL(HF::Interface::SERVER_ROLE, itf->role);
